<?php
    ...
    class Context extends \Magento\Framework\View\Element\Template\Context
    {
         ...
         * @param \Ogenc\Shopfinder\Helper\Data                           $devToolHelper
         * @param \Magento\Framework\Registry                             $registry
         * @param \Ogenc\Shopfinder\Model\Config                          $config
        ...
        public function __construct(
            ...
            \Ogenc\Shopfinder\Helper\Data $devToolHelper,
            \Magento\Framework\Registry $registry,
            \Ogenc\Shopfinder\Model\Config $config,
            ...
            parent::__construct($request, $layout, $eventManager, $urlBuilder, $cache, $design, $session, $sidResolver,
                $scopeConfig, $assetRepo, $viewConfig, $cacheState, $logger, $escaper, $filterManager, $localeDate,
                $inlineTranslation, $filesystem, $viewFileSystem, $enginePool, $appState, $storeManager, $pageConfig,
                $resolver, $validator);
        }
         ...
         *
         * @return \Ogenc\Shopfinder\Helper\Data
         */
         ...
         *
         * @return \Ogenc\Shopfinder\Model\Config
         */
